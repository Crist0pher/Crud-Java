...
@Controller
public class GenericController<ID, Model extends GenericEntity<ID>, Repository extends JpaRepository<Model, ID>, Service extends GenericService<ID, Model, Repository>> {
